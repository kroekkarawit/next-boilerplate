  ...
  return (
    <div className="bg-gradient-to-b from-blue-600 to-blue-800 text-white min-h-screen">
      ...
      <section className="h-screen flex flex-col items-center justify-center text-center px-4">
        <h1 className="text-5xl md:text-6xl font-bold mb-6">{homeI18n('title')}</h1>
        <p className="text-xl mb-8 max-w-2xl">Streamline your workflow, boost productivity, and achieve your goals with our cutting-edge solution.</p>
      ...
      <section id="features" className="py-16 px-8 bg-white text-blue-800">
